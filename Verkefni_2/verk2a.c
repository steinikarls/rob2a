...
task main()
{
	...
	int time;		// int time for the distance
	for(time=1000; time<=5000;time=time+1000)  // for loop for driving back and forth
{
motor[rightMotor] = 127;		  // Motor on port2 is run at full (127) power forward
	...
	wait1Msec(time);			        // Robot runs previous code for time milliseconds before moving on

	motor[rightMotor] = 0;		  // Motor on port2 is stop
	motor[leftMotor]  = 0;		  // Motor on port3 is stop
	wait1Msec(500);			        // Robot waits
